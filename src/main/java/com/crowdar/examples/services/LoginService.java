...
public class LoginService {
    ...
    public static void verifyLogIn(){
        MobileActionManager.waitVisibility(LoginConstants.LOG_IN_VERIFY_LOCATOR);
        Assert.assertTrue(MobileActionManager.isVisible(LoginConstants.LOG_IN_VERIFY_LOCATOR), LoginConstants.VIEW_NOT_DISPLAYED_MESSAGE);
    }
}
